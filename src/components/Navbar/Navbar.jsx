        ...
        <div className="py-4 border-t border-gray-200">
          <div className="flex flex-col space-y-1">
            ...
            <div className="pt-4 mt-2 border-t border-gray-200 flex flex-col space-y-2">
              {
                loggedIn ? <Link href="/login" className="flex items-center justify-center space-x-2 px-3 py-2.5 text-sm font-medium border border-gray-300 rounded-md hover:bg-gray-100 transition-colors">
                  <span>LogOut</span>
                </Link> : <>
